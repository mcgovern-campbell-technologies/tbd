...
// MERGE (elec:Position {name: 'Electrician'})
// MERGE (lev1:PositionLevel { value: 2, label: 'one', abreviation: 'I'})
// MERGE (lev2:PositionLevel { value: 3, label: 'two', abreviation: 'II'})
// MERGE (lev3:PositionLevel { value: 1, label: 'specialist', abreviation: 'spec'})
// CREATE UNIQUE (elec)-[:HAS_LEVEL]-(lev1)
// CREATE UNIQUE (elec)-[:HAS_LEVEL]-(lev2)
// CREATE UNIQUE (elec)-[:HAS_LEVEL]-(lev3)
// RETURN c
